...
document.getElementById('form-submit').addEventListener('click', function (event) {
  ...
  if (searchEntry.value) {
    fetch('https://api.opencagedata.com/geocode/v1/json?q=' + searchEntry.value + '&key=c740ebf9cdd34742986f08e8fd78033c&language=en&pretty=1&countrycode=us').then(function (response) {
      return response.json();
    }).then(function (data) {
